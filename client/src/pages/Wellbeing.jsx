    ...
    return (
      <div className="page">
        <PageBanner
          ...
          subtitle="School-wide weekly trend, shown only as an anonymous average — individual responses are never visible to admins."
        />
        <Reveal>
          <GlassCard>
            ...
            {aggregate.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={280}>
                <LineChart data={aggregate}>
                  ...
                  <Line type="monotone" dataKey="avgScore" stroke="var(--primary, #7a1e34)" strokeWidth={3} dot={{ r: 4 }} />
                </LineChart>
              </ResponsiveContainer>
            )}
  ...
  return (
    <div className="page">
      <PageBanner
        ...
        subtitle="A quick, private pulse — only you and the school's anonymous weekly average ever see this."
      />
          ...
          {history.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={history}>
                ...
                <YAxis domain={[1, 5]} allowDecimals={false} />
                <Tooltip />
                <Line type="monotone" dataKey="score" stroke="var(--accent, #15803d)" strokeWidth={3} dot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          )}
        </GlassCard>
