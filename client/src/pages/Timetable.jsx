  ...
  return (
    <div className="page">
      <PageBanner
        ...
        subtitle={user.role === 'admin' ? "Build out each teacher's weekly class schedule. Room and class clashes are checked automatically." : 'Your class schedule for the week.'}
      />
